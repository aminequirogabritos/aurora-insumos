...
exports.createCliente = (req, res) => {
    ...
    Cliente.createCliente(cliente, (err, data) => {
        if (err)
            res.status(500).send({
                message:
...
exports.findAllClientes = (req, res) => {
    ...
    Cliente.getAllClientes(title, (err, data) => {
        if (err)
            res.status(500).send({
                message:
...
exports.findOneCliente = (req, res) => {
    Cliente.findClienteById(req.params.id, (err, data) => {
        if (err) {
...
exports.updateClienteStock = (req, res) => {
    ...
    Cliente.updateClienteStockById(
        req.params.id,
