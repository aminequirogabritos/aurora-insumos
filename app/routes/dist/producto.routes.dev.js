...
module.exports = function (app) {
  var productos = require("../controllers/producto.controller.js");

  var router = require("express").Router(); //Create new product


  router.post("/", productos.createProducto); // Retrieve all Tutorials

  router.get("/", productos.findAllProductos); //
  // Retrieve a single Tutorial with id

  router.get("/:id", productos.findOneProducto); // Update a Product's stock with id
