...
function auxiliar(parametro) {
  ...
  switch (parametro) {
    case categoria:
      aux1 = "CREATE TABLE IF NOT EXISTS `aurorainsumosdb`.`Categoria` (" +
      ...
      break;
    case producto:
      aux1 = "CREATE TABLE IF NOT EXISTS `aurorainsumosdb`.`Producto` (" +
      ...
      break;
    case cliente:
      aux1 = "CREATE TABLE IF NOT EXISTS `aurorainsumosdb`.`Cliente` (" +
      ...
      break;
    case detalle:
      aux1 = "CREATE TABLE IF NOT EXISTS `aurorainsumosdb`.`Detalle` (" +
      ...
      break;
    case venta:
      aux1 = "CREATE TABLE IF NOT EXISTS `aurorainsumosdb`.`Venta` (" +
